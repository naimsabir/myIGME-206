    ...
    public partial class Form1 : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 30; i++)
            {
                ...
                node = new BTree(rand.Next(1, 51), root);
            }
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            node = new BTree("Fall guys", null);

            root = node;

            node = new BTree("Crumpets", root);
            node = new BTree("Basketball", root);
            node = new BTree("Apricot", root);
            node = new BTree("Eververse", root);
            node = new BTree("Destiny", root);
            node = new BTree("Fallout", root);
            node = new BTree("Casper", root);
            node = new BTree("Beyblade", root);
            node = new BTree("Afterparty", root);
            node = new BTree("Everyday", root);
            node = new BTree("Dogs", root);
            node = new BTree("Full throttle", root);
            node = new BTree("Capybara", root);
            node = new BTree("Abercrombie", root);
