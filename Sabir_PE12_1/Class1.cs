...
namespace Sabir_PE12_1 //pretend this is CourseLib
{
    //Class: Schedule
    //Author: Naim Sabir
    //Purpose: to create two DateTime Objects and a list of days of the week
    //Restrictions: None
    ...
    public class Courses
    {
        ...
        //Method: Remove
        //Purpose: if string used to call the method isn't null it will be removed
        //Restrictions: None
