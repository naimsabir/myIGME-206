...
namespace Sabir_UnitTest_2
{
    ...
    class Program
    {
        ...
        //Method: Main
        //Purpose:Create a console application that modifies the attached "Number Sorter" application
        //to request sentences and sort the words in the sentence in ascending or descending order.
        ...
        {
            //Pseudo Code:
            //1. Modify the existing code to accept strings instead of numbers
            //2. Change comments to match with new code
        ...
        start:
            ...
            foreach (string sWord in sSentence)
            {
                ...
                try
                {
                    // if the word is a word store it in the sThisWord string
                    sThisWord = (sWord);
            ...
            nUnsortedLength = 0;
            foreach (string word in sSentence)
            {
                ...
                // store it is sThisWord (we know they are all valid now)
                sThisWord = (word);
        ...
        static string FindLowestValue(string[] array)
        {
            ...
            {
               if(word.CompareTo(returnWord) < 0)
                {
                    returnWord = word;
                }
            }
        ...
        static void RemoveUnsortedValue(string removeValue, ref string[] array)
        {
            ...
            foreach (string srcWord in array)
            {
                ...
                // insert the source wordr into the new array
